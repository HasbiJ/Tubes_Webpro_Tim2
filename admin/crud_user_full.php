<?php
session_start();
// FIX: Corrected the path to include the file from the parent directory
...
if (isset($_GET['hapus'])) {
    ...
    echo "<script>alert('User berhasil dihapus!'); window.location.href='crud_user_full.php';</script>";
}
...
if (isset($_POST['submit'])) {
    ...
    if ($query) {
        ...
        echo "<script>alert('User berhasil ditambahkan!'); window.location.href='crud_user_full.php';</script>";
    }
}
?>
...
<body>
    <header>
    <div class="brand">
      <img src="../frontend_js/logo project website uid.png" alt="logo" class="logo">
      <div>
        <div>EduFlex</div>
    ...
    <div class="right-section">
      <div class="account">
         ...
         <a href="../logout.php" style="margin-left: 15px; color: #ff6b00; text-decoration: none; font-weight: bold;">Keluar</a>
      </div>
    </div>
  </header>
