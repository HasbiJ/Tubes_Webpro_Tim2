...
<body>
  ...
  <div class="container">
    ...
    <main class="main">
      <section class="welcome" style="background-image: linear-gradient(135deg, rgba(11,26,58,0.85), rgba(255,107,0,0.6)), url('https://i.pinimg.com/736x/da/cf/5f/dacf5f38f433acfc30499bde1b7f42e0.jpg'); background-size: cover; background-position: center;">
      ...
      <div class="content-grid">
        <div class="left">
          ...
          <section class="card">
              ...
              <p style="font-size: 14px; color: #555; margin-bottom: 20px;">Silakan pilih menu kendali di bawah ini untuk mengelola entitas data master pada database sistem EduFlex.</p>
              
              <div class="admin-actions-grid">
                  <div class="action-box">
                      <h3>Manajemen Pengguna</h3>
                      <p>Kelola data kredensial login, pendaftaran data guru baru, serta manipulasi data akun siswa.</p>
                      <a href="buat_user.php" class="btn-primary">Buka Fitur User</a>
                  </div>
                  <div class="action-box">
                      <h3>Manajemen Jadwal</h3>
                      <p>Atur pemetaan mata pelajaran, pembagian ruang kelas, dan jam operasional mengajar guru.</p>
                      <a href="buat_jadwal.php" class="btn-primary">Buka Fitur Jadwal</a>
                  </div>
              </div>
          </section>
          ...
          <section class="card">
              ...
              <p style="font-size: 14px; color: #555; margin-bottom: 15px;">Berikut adalah total rekaman aktif yang tersimpan di dalam engine database saat ini.</p>
        ...
        <div class="right">
          <section class="card">
              ...
              <div class="berita-item">
                  ...
                  <p style="font-size: 12px; margin: 5px 0 0 0; color: #666;">Akses penuh diizinkan untuk melakukan aksi eksekusi CREATE, READ, UPDATE, dan DELETE.</p>
              </div>
          </section>
        </div>
      </div>
